        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auditoria_Usuarios_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CierresCaja_Usuarios_UserId",
                        column: x => x.UserId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetalleCompras_Compras_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "Compras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalleCompras_Productos_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Productos_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Items_Ventas_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovimientosCaja_Usuarios_UserId",
                        column: x => x.UserId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovimientosCaja_Ventas_SaleId",
                        column: x => x.SaleId,
                        principalTable: "Ventas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auditoria_UserId",
                table: "Auditoria",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CierresCaja_UserId",
                table: "CierresCaja",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleCompras_ProductId",
                table: "DetalleCompras",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DetalleCompras_PurchaseId",
                table: "DetalleCompras",
                column: "PurchaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosCaja_SaleId",
                table: "MovimientosCaja",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_MovimientosCaja_UserId",
                table: "MovimientosCaja",
                column: "UserId");
